...
// Changer de mois au swipe sur mobile (demande du 12/09/2026, "sans devoir cliquer sur la
// flèche") : posé une seule fois sur le conteneur entier (label + flèches + grille), pas
// seulement sur #live-cal-grid, pour un geste plus facile à déclencher sur un petit écran.
// Seuil de 40px et un ratio horizontal/vertical de 1.5 pour ne pas confondre avec un
// simple scroll vertical de la page (#live-panel-calendar a overflow-y:auto).
(function wireLiveCalSwipe() {
    const el = document.getElementById('live-panel-calendar');
    if (!el) return;
    ...
    el.addEventListener('touchend', (e) => {
        ...
        window.shiftLiveCalMonth(dx < 0 ? 1 : -1);
    }, { passive: true });
})();
...
window.addEventListener('firebase-ready', async (e) => {
    ...
    // seul endroit pour les afficher/rafraîchir plutôt qu'un bout de JS dupliqué par
    // page. Idempotent : ne fait rien sur une page qui n'a pas ces boutons dans son
    // HTML (ex: page de login). L'icône "Ami" (profil public) a été retirée du header
    // (demande du 13/09/2026) au profit du bouton colore dans #profile-menu.
    ...
    // bas mobile, aucun lien desktop n'existait). Même bouton que message-icon-btn
    // (masqué par défaut, affiché une fois connecté).
    ...
    wrap.innerHTML = `
        ...
        <div class="dropdown-container">
            ...
            <div id="mti-gear-menu" class="dropdown-menu hidden">
                <a href="profile.html" class="dropdown-profile-btn"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg><span data-i18n="profileMenuOption">Your Profile</span></a>
                <div class="dropdown-divider"></div>
                <a href="map-destinations.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg><span data-i18n="exploreDestOption">Explore Destinations</span></a>
                <a href="map-artists.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg><span data-i18n="exploreArtistsOption">Explore Artists</span></a>
                <div class="dropdown-divider"></div>
                <a href="account.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg><span data-i18n="accountOption">Your Account</span></a>
                <a href="visited.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg><span data-i18n="visitedOption">Visited</span></a>
                <a href="wishlist.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.8 4.6c-1.6-1.6-4.2-1.6-5.8 0L12 7.6l-3-3c-1.6-1.6-4.2-1.6-5.8 0-1.6 1.6-1.6 4.2 0 5.8l8.8 8.8 8.8-8.8c1.6-1.6 1.6-4.2 0-5.8z"></path></svg><span data-i18n="wishlistOption">My Wishlist</span></a>
                <a href="trips.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg><span data-i18n="tripsOption">My Trips</span></a>
                <a href="settings.html" class="dropdown-option"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg><span data-i18n="settingsOption">Settings</span></a>
                <div class="dropdown-divider"></div>
                <a href="index.html" class="dropdown-option" id="mti-logout-btn" style="color:#D42759; font-weight:bold;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg><span data-i18n="logoutOption">Logout</span></a>
            </div>
        </div>
    `;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (userAvatarEls.length > 0) {
        ...
        // Icône utilisateur générique (demande du 13/09/2026) : sur DESKTOP uniquement
        // (.user-avatar-btn), remplace l'initiale par une icône silhouette quand aucune
        // photo de profil n'est définie — la nav du bas mobile (.mbn-avatar) garde son
        // cercle coloré + initiale existant, non concerné par cette demande.
        const userIconSvg = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>';
        ...
        userAvatarEls.forEach(avatarEl => {
            ...
            if (savedPhoto && savedPhoto.trim() !== '') {
                ...
                avatarEl.innerHTML = userIconSvg;
            }
        });
    }
    ...
    if (document.getElementById('map') && typeof L !== 'undefined' && !map) {
        ...
        // Alignement du bouton de géolocalisation (#locate-country-btn) sur le même axe
        // vertical que le control de zoom Leaflet (demande du 13/09/2026, toujours signalé
        // décalé malgré la valeur fixe précédente en CSS — celle-ci supposait des boutons
        // Leaflet de 26px, mais ils passent à 30px sur les appareils détectés tactiles via
        // la classe .leaflet-touch, ce qui cassait l'alignement calculé en dur). On mesure
        // désormais la position réelle du control après son rendu plutôt que de deviner sa
        // largeur, et on réajuste au redimensionnement (ex: franchissement du point de
        // rupture mobile qui masque le control de zoom — voir .leaflet-control-zoom dans
        // style.css, où le bouton reprend alors sa propre position via la media query).
...
const translations = {
    ...
    fr: {
        ...
        setResetBanners: "Réinitialiser la bannière",
    ...
    es: {
        ...
        setResetBanners: "Restablecer banner",
    ...
    it: {
        ...
        setResetBanners: "Reimposta banner",
    ...
    pt: {
        ...
        setResetBanners: "Redefinir banner",
    ...
    ja: {
        ...
        tabExplore: "探索", tabMyItinerary: "マイ旅程", yourRating: "評価", foodQualityRating: "料理の質", valueForMoneyRating: "コストパフォーマンス", accessibilityRating: "アクセスしやすさ", siteQualityRating: "場所の質", wishlistStat: "ユーザーの{pct}%がこの場所をウィッシュリストに追加しました", friendsVisitedStat: "{count}人の友達がここを訪れました", friendsVisitedStatOne: "1人の友達がここを訪れました", whenDidYouVisit: "いつ訪れましたか？", saveMemory: "思い出を保存", myVisitTab: "マイビジット", tabReviews: "レビュー", tabInfo: "情報", tabStory: "ストーリー", lGroup: "グループ：", lMembers: "メンバー：", lCountry: "国：", lCity: "都市：", lDate: "日付：", lEpisode: "エピソード：", lWatch: "リンク：", lOfficialLink: "公式リンク", lFollow: "フォロー:", lWatchEpi: "画面の中", lPractical: "実用情報とアクセス", lLearnMore: "この場所についてもっと詳しく", lAddress: "住所", lOpenMap: "Googleマップで開く", lStoryPlace: "この場所の物語", lStoryBts: "BTSの足跡をたどって", lTipsTitle: "「SCREEN TO STREET」のヒント", lHowToGetThere: "行き方：", memoryNotesLabel: "メモ（任意）", memoryNotesPlaceholder: "この場所について覚えていることは？", reviewsCountLabel: "公開レビュー{n}件", reviewsWriteLabel: "レビューを書く", reviewsComposePlaceholder: "感想をシェアしましょう…", reviewsComposeMakePublic: "このレビューを公開する", reviewsComposePost: "レビューを投稿", memoryPhotoLabel: "写真を追加（任意）", memoryPhotoChoose: "写真を選択", memoryPhotoRemove: "削除", memoryMakePublic: "このレビューを公開する（他のユーザーに表示されます）", reviewsLoading: "レビューを読み込み中…", reviewsEmpty: "この場所にはまだ公開レビューがありません —「マイビジット」タブから最初のレビューを共有しましょう！",
    ...
    zh: {
        ...
        tabExplore: "探索", tabMyItinerary: "我的行程", yourRating: "你的评分", foodQualityRating: "食物质量", valueForMoneyRating: "性价比", accessibilityRating: "是否容易到达？", siteQualityRating: "场地质量", wishlistStat: "{pct}%的用户将这个地方加入了心愿单", friendsVisitedStat: "{count}位好友到访过这里", friendsVisitedStatOne: "1位好友到访过这里", whenDidYouVisit: "你什么时候去的？", saveMemory: "保存回忆", myVisitTab: "我的到访", tabReviews: "评价", tabInfo: "信息", tabStory: "故事", lGroup: "组合：", lMembers: "成员：", lCountry: "国家：", lCity: "城市：", lDate: "日期：", lEpisode: "集数：", lWatch: "链接：", lOfficialLink: "官方链接", lFollow: "关注：", lWatchEpi: "画面中", lPractical: "实用信息与交通", lLearnMore: "了解更多关于此地点的信息", lAddress: "地址", lOpenMap: "在谷歌地图中打开", lStoryPlace: "这个地方的故事", lStoryBts: "追随BTS的足迹", lTipsTitle: "「SCREEN TO STREET」小贴士", lHowToGetThere: "交通方式：", memoryNotesLabel: "你的备注（可选）", memoryNotesPlaceholder: "你还记得这个地方的什么？", reviewsCountLabel: "{n}条公开评价", reviewsWriteLabel: "写下你的评价", reviewsComposePlaceholder: "分享你的感受…", reviewsComposeMakePublic: "公开此评价", reviewsComposePost: "发布评价", memoryPhotoLabel: "添加照片（可选）", memoryPhotoChoose: "选择照片", memoryPhotoRemove: "移除", memoryMakePublic: "公开此评价（其他用户可见）", reviewsLoading: "正在加载评价…", reviewsEmpty: "该地点暂无公开评价——从「我的到访」标签页分享第一条评价吧！",
...
// ==========================================
// BADGES GÉOLOCALISÉS (demande du 13/09/2026, "un peu comme Pokemon GO") : dès que la
...
async function loadMyUnlockedBadges() {
    if (myUnlockedBadgeIds) return myUnlockedBadgeIds;
    myUnlockedBadgeIds = new Set();
    const user = window.firebaseCurrentUser;
    if (user && typeof window.fetchPublicProfile === 'function') {
        try {
            const profile = await window.fetchPublicProfile(user.uid);
            Object.keys(profile.badges || {}).forEach(id => myUnlockedBadgeIds.add(id));
        } catch (e) {
            console.warn('Chargement des badges débloqués échoué :', e);
        }
    }
    return myUnlockedBadgeIds;
}

async function checkBadgeUnlocksNearPosition(pos) {
    if (!window.firebaseCurrentUser || typeof celebLocations === 'undefined') return;
    const unlocked = await loadMyUnlockedBadges();
    const { latitude, longitude } = pos.coords;
    celebLocations.forEach(loc => {
        const idStr = String(loc.id);
        if (unlocked.has(idStr) || badgeUnlockChecksInFlight.has(idStr)) return;
        if (typeof loc.lat !== 'number' || typeof loc.lng !== 'number') return;
        const distanceMeters = haversineKm(latitude, longitude, loc.lat, loc.lng) * 1000;
        if (distanceMeters <= BADGE_UNLOCK_RADIUS_METERS) {
            badgeUnlockChecksInFlight.add(idStr);
...
const badgeSparkleSvg = '<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1l2.6 7.4L22 11l-7.4 2.6L12 21l-2.6-7.4L2 11l7.4-2.6L12 1z"></path></svg>';
const badgeLockSvg = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>';

function ensureBadgeUnlockModal() {
    let modal = document.getElementById('badge-unlock-modal');
    if (modal) return modal;
    modal = document.createElement('div');
    ...
    modal.innerHTML = `
        <div class="badge-unlock-card">
            ...
            <div class="badge-unlock-rank" id="badge-unlock-rank"></div>
            <button type="button" class="badge-unlock-btn" id="badge-unlock-view-btn" data-i18n="badgeUnlockViewBtn">View my collection</button>
        </div>`;
    document.body.appendChild(modal);
    // updateUI() est idempotent (relit juste tous les [data-i18n] du document, voir plus
    // bas) — nécessaire ici puisque cette modale est injectée à la volée bien après le
    // passage initial d'updateUI() au chargement de la page, contrairement au reste du
    // HTML statique déjà traduit à ce moment-là.
...
function showBadgeUnlockCelebration(loc, rank) {
    ...
    photoEl.style.backgroundImage = loc.img ? `url('${loc.img}')` : '';
    document.getElementById('badge-unlock-name').textContent = loc.name;
...
window.openFilteredListModal = function(type) {
    ...
    if (type === 'locations') {
        ...
        // Sur mobile (demande du 13/09/2026), un tap sur un lieu de cette liste (ouverte
        // depuis le KPI "LOCATIONS" en haut à gauche de la carte) recentre juste la carte
        // sur son point, sans ouvrir la fiche détail — même choix que la recherche de la
        // sidebar/barre mobile juste au-dessus dans ce fichier. Sur ordinateur, ça ouvre
        // toujours la fiche comme avant (assez de place pour les deux à la fois).
        const isMobile = window.matchMedia && window.matchMedia('(max-width: 760px)').matches;
        currentFilteredLocations.forEach(loc => {
            const clickAction = isMobile
                ? `closeModal('list-modal'); map.flyTo([${loc.lat}, ${loc.lng}], 16, { duration: 0.6 });`
                : `closeModal('list-modal'); window.openDetailsPanel(${loc.id}); map.flyTo([${loc.lat}, ${loc.lng}], 16, { duration: 0.6 });`;
            content.innerHTML += `
                <div style="padding: 12px; background: #faf9fc; border-radius: 8px; border: 1px solid #e2e8f0; cursor: pointer; transition: 0.2s;" onmouseover="this.style.borderColor='#D42759'" onmouseout="this.style.borderColor='#e2e8f0'" onclick="${clickAction}">
...
function renderFlexibleMonthGrid(prefix) {
    ...
    if (!grid) return;
    // Abrégés sur 3 lettres (demande du 12/09/2026, "n'affiche pas le nom des mois en
    // entier") : ces tuiles doivent rester compactes dans une grille à plusieurs colonnes,
    // un nom complet ("September 2026") forçait certaines tuiles à passer à la ligne.
    const monthNames = currentLang === 'fr'
