...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.toggleMobileMenu = function() {
        ...
        if (sidebar) {
            ...
            // carte" (icône croix) et les autres icônes du top-nav (langue, panier, amis,
            // profil) sont masquées le temps que le menu occupe tout l'écran, pour ne pas
            // se superposer visuellement au menu.
            const btn = document.getElementById('mobile-menu-btn');
            if (btn) btn.classList.toggle('is-open', isOpen);
            const topNav = btn ? btn.closest('.top-nav') : null;
...
let celebLocations = [
  ...
  tipsList: [
    ...
    { id: 40, name: "Stade de France", group: "BTS", member: "All", country: "France", city: "Saint-Denis", category: "Concerts", year: "2019 · 2026", episode: "Love Yourself: Speak Yourself & World Tour 'ARIRANG'", episodeLink: "https://en.wikipedia.org/wiki/Love_Yourself_World_Tour", address: "ZAC du Cornillon Nord", lat: 48.9244, lng: 2.3601, img: "https://commons.wikimedia.org/wiki/Special:FilePath/Stade_de_France_1000_023.jpg",
      fullDescription: { en: `<p><b>June 7–8, 2019 — Love Yourself: Speak Yourself.</b> BTS's first show at Stade de France came on their first-ever stadium tour, the French leg following stops at the Rose Bowl, MetLife Stadium, and Allianz Parque — one of the earliest signs that a K-pop act could fill France's national stadium, a venue built for football finals and Olympic ceremonies.</p><p><b>July 17–18, 2026 — World Tour "ARIRANG."</b> Seven years later, BTS returned to the same stadium for the Paris stop of "ARIRANG," their sixth all-stadium tour and first full run together since completing military service. Two visits, seven years apart, to the same national stadium — a rare marker of just how long BTS's stadium-level drawing power in Europe has lasted.</p>`,
        fr: `<p><b>7–8 juin 2019 — Love Yourself: Speak Yourself.</b> Le premier passage de BTS au Stade de France a eu lieu lors de sa toute première tournée en stades, l'étape française suivant les dates au Rose Bowl, au MetLife Stadium et à l'Allianz Parque — l'un des premiers signes qu'un groupe de K-pop pouvait remplir le stade national français, une enceinte construite pour les finales de football et les cérémonies olympiques.</p><p><b>17–18 juillet 2026 — World Tour « ARIRANG ».</b> Sept ans plus tard, BTS est revenu dans ce même stade pour l'étape parisienne d'« ARIRANG », sa sixième tournée entièrement en stades et la première tournée complète du groupe depuis la fin de son service militaire. Deux passages, à sept ans d'écart, dans le même stade national — un signe assez rare de la durée du pouvoir d'attraction de BTS au niveau stade en Europe.</p>` },
    ...
    {"id":113,"name":"Gocheok Sky Dome","group":"BTS","member":"All","country":"South Korea","city":"Seoul","category":"Concerts","year":"2017","episode":"BTS Live Trilogy Episode III: The Wings Tour","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","address":"","lat":37.4986,"lng":126.8672,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Gocheok_Skydome_Inside.JPG","fullDescription":{"en":"<p><b>February 18–19, 2017 — Opening night.</b> Gocheok Sky Dome, then a brand-new domed stadium in Seoul, hosted the very first shows of \"The Wings Tour\" — the tour that would go on to sell out 40 dates across 17 cities and 550,000 tickets over the course of the year.</p><p><b>December 8–10, 2017 — \"The Final.\"</b> Ten months and a trip around the world later, BTS closed out the same tour in the same building, this time billed as \"The Wings Tour: The Final\" — a homecoming after stops in South America, North America, Southeast Asia, Japan, and Taiwan.</p>","fr":"<p><b>18–19 février 2017 — Soirée d'ouverture.</b> Le Gocheok Sky Dome, alors un stade à dôme tout juste inauguré à Séoul, a accueilli les toutes premières dates de « The Wings Tour » — une tournée qui allait finalement afficher complet sur 40 dates dans 17 villes, pour 550 000 billets vendus sur l'année.</p><p><b>8–10 décembre 2017 — « The Final ».</b> Dix mois et un tour du monde plus tard, BTS a clôturé cette même tournée dans la même salle, cette fois sous le nom « The Wings Tour: The Final » — un retour au pays après des étapes en Amérique du Sud, en Amérique du Nord, en Asie du Sud-Est, au Japon et à Taïwan.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":114,"name":"Movistar Arena","group":"BTS","member":"All","country":"Chile","city":"Santiago","category":"Concerts","year":"2017","episode":"The Wings Tour","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","address":"","lat":-33.4672,"lng":-70.6323,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Movistar_arena_2018.jpg","fullDescription":{"en":"<p>BTS played Movistar Arena on March 11–12, 2017, during the South American leg of \"The Wings Tour\" — their first time performing in Chile. Tickets for the 15,500-seat arena, the country's largest indoor venue, sold out in under two hours: at the time it was the fastest-selling concert in Chilean history, a pace only Maroon 5's 2016 show in the city had come close to matching.</p><p>The Santiago stop is still cited as the moment that made clear just how far BTS's fanbase reached outside Asia and North America, well before the group's biggest stadium tours.</p>","fr":"<p>BTS s'est produit au Movistar Arena les 11 et 12 mars 2017, lors de l'étape sud-américaine de « The Wings Tour » — sa toute première date au Chili. Les billets pour cette salle de 15 500 places, la plus grande enceinte couverte du pays, se sont vendus en moins de deux heures : à l'époque, il s'agissait du concert le plus rapidement vendu de l'histoire du Chili, un rythme que seul le concert de Maroon 5 en 2016 dans la même ville avait approché.</p><p>L'étape de Santiago reste citée comme l'un des premiers signes clairs de l'ampleur du public de BTS en dehors de l'Asie et de l'Amérique du Nord, bien avant les plus grandes tournées en stade du groupe.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":115,"name":"Citibank Hall","group":"BTS","member":"All","country":"Brazil","city":"São Paulo","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":-23.599,"lng":-46.691,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Credicardhall-sao-paulo.JPG","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>March 19–20, 2017 — The Wings Tour.</b> Citibank Hall in São Paulo hosted two sold-out nights on BTS's first-ever South American tour dates, with roughly 15,000 tickets sold per show, as \"The Wings Tour\" made its first stop on the continent.</p>","fr":"<p><b>19–20 mars 2017 — The Wings Tour.</b> Le Citibank Hall de São Paulo a accueilli deux soirs à guichets fermés lors des toutes premières dates sud-américaines de BTS, avec environ 15 000 billets vendus par concert, alors que « The Wings Tour » faisait sa première étape sur le continent.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":116,"name":"Prudential Center","group":"BTS","member":"All","country":"USA","city":"Newark, NJ","category":"Concerts","year":"2017 · 2018","episode":"The Wings Tour & Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":40.7336,"lng":-74.171,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Pudcentnewarkjeh.JPG","fullDescription":{"en":"<p><b>March 23–24, 2017 — The Wings Tour.</b> BTS's first visit to Prudential Center came as part of the North American leg of \"The Wings Tour,\" one of the stops that sold out within minutes as demand for the group's live shows in the US kept climbing.</p><p><b>September 28–29, 2018 — Love Yourself World Tour.</b> Eighteen months later, BTS returned to the same arena for two more sold-out nights on the \"Love Yourself World Tour,\" this time as one of the biggest acts in the world rather than a rising one — the same building, twice, marking two very different points in the group's career.</p>","fr":"<p><b>23–24 mars 2017 — The Wings Tour.</b> La première venue de BTS au Prudential Center s'inscrivait dans l'étape nord-américaine de « The Wings Tour », l'une des dates qui s'est vendue en quelques minutes tant la demande pour les concerts du groupe aux États-Unis ne cessait de grimper.</p><p><b>28–29 septembre 2018 — Love Yourself World Tour.</b> Dix-huit mois plus tard, BTS est revenu dans la même salle pour deux nouvelles soirées à guichets fermés lors du « Love Yourself World Tour », cette fois en tant que l'un des plus gros groupes au monde plutôt qu'un groupe montant — la même salle, deux fois, à deux moments très différents de la carrière du groupe.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    ...
    {"id":118,"name":"Honda Center","group":"BTS","member":"All","country":"USA","city":"Anaheim, CA","category":"Concerts","year":"2017","episode":"The Wings Tour","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","address":"","lat":33.8078,"lng":-117.8766,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Honda-ext-arch.JPG","fullDescription":{"en":"<p>BTS played two nights at the Honda Center — home of the NHL's Anaheim Ducks — on April 1–2, 2017, closing out the North American leg of \"The Wings Tour\" after Newark and Chicago. Tickets for the whole North American run sold out within minutes, part of the wave of demand that made 2017 the year BTS's US fanbase went from dedicated to impossible to ignore.</p><p>The Anaheim stop is often remembered by early ARMY as one of the more intimate arena shows before the group moved into stadiums two years later.</p>","fr":"<p>BTS s'est produit deux soirs au Honda Center — domicile des Anaheim Ducks en NHL — les 1er et 2 avril 2017, clôturant l'étape nord-américaine de « The Wings Tour » après Newark et Chicago. Les billets pour toute cette étape nord-américaine se sont vendus en quelques minutes, partie de la vague de demande qui a fait de 2017 l'année où la base de fans américaine de BTS est passée de dévouée à impossible à ignorer.</p><p>L'étape d'Anaheim reste souvent citée par les premières ARMY comme l'un des concerts en arène les plus intimistes avant le passage du groupe aux stades deux ans plus tard.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":119,"name":"Thunder Dome (Bangkok Indoor Stadium)","group":"BTS","member":"All","country":"Thailand","city":"Bangkok","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":13.8083,"lng":100.6144,"img":"https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>April 22–23, 2017 — The Wings Tour.</b> BTS played two nights in Bangkok's Muang Thong Thani complex for the Thai leg of \"The Wings Tour,\" reportedly drawing around 20,000 fans across the two shows — part of a run that would go on to gather over 550,000 fans worldwide by the end of 2017.</p>","fr":"<p><b>22–23 avril 2017 — The Wings Tour.</b> BTS a donné deux concerts dans le complexe Muang Thong Thani de Bangkok pour l'étape thaïlandaise de « The Wings Tour », attirant environ 20 000 fans sur les deux soirs — dans le cadre d'une tournée qui a rassemblé plus de 550 000 fans dans le monde d'ici la fin de 2017.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":120,"name":"ICE BSD City","group":"BTS","member":"All","country":"Indonesia","city":"Jakarta","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":-6.3021,"lng":106.6528,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Indonesia_Convention_Exhibition,_BSD_City.jpg","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>April 29, 2017 — The Wings Tour.</b> The Indonesia Convention Exhibition (ICE) in BSD City hosted BTS's first-ever concert in Indonesia, part of the Southeast Asian leg of \"The Wings Tour.\" The show ran a 27-song set opening with \"Not Today,\" part of a tour that would go on to gather over 550,000 fans worldwide by the end of 2017.</p>","fr":"<p><b>29 avril 2017 — The Wings Tour.</b> L'Indonesia Convention Exhibition (ICE) de BSD City a accueilli le tout premier concert de BTS en Indonésie, dans le cadre de l'étape sud-est-asiatique de « The Wings Tour ». Le show comptait 27 titres et s'ouvrait sur « Not Today », dans le cadre d'une tournée qui a rassemblé plus de 550 000 fans dans le monde d'ici la fin de 2017.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":121,"name":"Mall of Asia Arena","group":"BTS","member":"All","country":"Philippines","city":"Manila","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":14.5352,"lng":120.9822,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/MOA_Arena,_Pasay,_Sep_2025.jpg","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>May 6–7, 2017 — The Wings Tour.</b> Mall of Asia Arena in Pasay hosted two nights of BTS's \"The Wings Tour,\" part of the Southeast Asian leg of a run that would go on to gather over 550,000 fans worldwide by the end of 2017 — one of the group's first major shows in the Philippines.</p>","fr":"<p><b>6–7 mai 2017 — The Wings Tour.</b> La Mall of Asia Arena, à Pasay, a accueilli deux soirs de « The Wings Tour » de BTS, dans le cadre de l'étape sud-est-asiatique d'une tournée qui a rassemblé plus de 550 000 fans dans le monde d'ici la fin de 2017 — l'un des premiers grands concerts du groupe aux Philippines.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":122,"name":"AsiaWorld-Expo","group":"BTS","member":"All","country":"Hong Kong","city":"Hong Kong","category":"Concerts","year":"2017 · 2019","episode":"The Wings Tour · Love Yourself: Speak Yourself","address":"","lat":22.3213,"lng":113.9412,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/AsiaWorld-Expo,_Hong_Kong_(4448401990).jpg","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>May 13–14, 2017 — The Wings Tour.</b> AsiaWorld-Expo hosted two nights on the Hong Kong stop of \"The Wings Tour,\" part of a run that gathered 550,000 fans across 40 shows worldwide.</p><p><b>March 20, 21, 23 & 24, 2019 — Love Yourself World Tour.</b> BTS returned to the same arena for four nights, part of a tour that drew over one million fans across 42 shows.</p>","fr":"<p><b>13–14 mai 2017 — The Wings Tour.</b> L'AsiaWorld-Expo a accueilli deux soirs de l'étape hongkongaise de « The Wings Tour », dans le cadre d'une tournée qui a rassemblé 550 000 fans sur 40 concerts.</p><p><b>20, 21, 23 et 24 mars 2019 — Love Yourself World Tour.</b> BTS est revenu dans la même salle pour quatre soirs, dans le cadre d'une tournée qui a réuni plus d'un million de fans sur 42 concerts.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":123,"name":"Qudos Bank Arena","group":"BTS","member":"All","country":"Australia","city":"Sydney","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":-33.8474,"lng":151.0631,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Qudos_Bank_Arena_(Sydney,_AUS)_2016.JPG","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>May 26, 2017 — The Wings Tour.</b> Qudos Bank Arena at Sydney Olympic Park hosted BTS's only Australian date of \"The Wings Tour,\" ahead of an extensive Japanese leg spanning 13 more shows that closed out the tour's Asia-Pacific run.</p>","fr":"<p><b>26 mai 2017 — The Wings Tour.</b> Le Qudos Bank Arena, à Sydney Olympic Park, a accueilli l'unique date australienne de « The Wings Tour » de BTS, avant une importante étape japonaise de 13 concerts supplémentaires qui a clôturé le passage de la tournée en Asie-Pacifique.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":124,"name":"Osaka-jo Hall","group":"BTS","member":"All","country":"Japan","city":"Osaka","category":"Concerts","year":"2017","episode":"The Wings Tour","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","address":"","lat":34.6873,"lng":135.5262,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Osaka-jo_Hall_in_201408.JPG","fullDescription":{"en":"<p>BTS played three nights at Osaka-jo Hall — right next to Osaka Castle — on May 30–31 and June 1, 2017, part of the Japanese leg of \"The Wings Tour.\" That leg alone covered six cities and roughly 145,000 tickets, evidence of how large and well-established BTS's Japanese fanbase already was by 2017.</p><p>The venue's location, in the grounds of one of Japan's most famous castles, makes it a common stop for fans doing a Wings Tour pilgrimage even outside concert dates.</p>","fr":"<p>BTS s'est produit trois soirs à l'Osaka-jo Hall — juste à côté du château d'Osaka — les 30, 31 mai et 1er juin 2017, dans le cadre de l'étape japonaise de « The Wings Tour ». Cette seule étape couvrait six villes et environ 145 000 billets, preuve de l'ampleur déjà considérable de la base de fans japonaise de BTS dès 2017.</p><p>L'emplacement de la salle, dans l'enceinte de l'un des châteaux les plus célèbres du Japon, en fait une étape courante pour les fans faisant un pèlerinage sur les traces de la Wings Tour, même en dehors des dates de concert.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":125,"name":"Hiroshima Green Arena","group":"BTS","member":"All","country":"Japan","city":"Hiroshima","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":34.3971,"lng":132.4652,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Hiroshima_Green_Arena_-_Dec_31,_2007.jpg","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>June 7, 2017 — The Wings Tour.</b> Hiroshima Green Arena hosted a single Japanese-leg date of BTS's \"The Wings Tour,\" the group's first arena-scale tour across Japan following the runaway success of the \"Wings\" album. The Japan leg ran through June and July 2017 across five cities, part of a wider run that also crossed North America, South America and Australia.</p>","fr":"<p><b>7 juin 2017 — The Wings Tour.</b> La Hiroshima Green Arena a accueilli une date de l'étape japonaise de « The Wings Tour » de BTS, leur première tournée à l'échelle des arénas au Japon après le succès de l'album « Wings ». Cette étape japonaise s'est déroulée en juin et juillet 2017 dans cinq villes, dans le cadre d'une tournée qui a aussi traversé l'Amérique du Nord, l'Amérique du Sud et l'Australie.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":126,"name":"Nippon Gaishi Hall","group":"BTS","member":"All","country":"Japan","city":"Nagoya","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":35.1256,"lng":136.9686,"img":"https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>June 14–15, 2017 — The Wings Tour.</b> Nippon Gaishi Hall hosted a two-night stand on the Japanese leg of BTS's \"The Wings Tour,\" the group's first arena-scale tour across Japan following the runaway success of the \"Wings\" album. The Japan leg ran through June and July 2017 across five cities, part of a wider run that also crossed North America, South America and Australia.</p>","fr":"<p><b>14–15 juin 2017 — The Wings Tour.</b> Le Nippon Gaishi Hall a accueilli deux soirs consécutifs de l'étape japonaise de « The Wings Tour » de BTS, leur première tournée à l'échelle des arénas au Japon après le succès de l'album « Wings ». Cette étape japonaise s'est déroulée en juin et juillet 2017 dans cinq villes, dans le cadre d'une tournée qui a aussi traversé l'Amérique du Nord, l'Amérique du Sud et l'Australie.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":127,"name":"Saitama Super Arena","group":"BTS","member":"All","country":"Japan","city":"Saitama","category":"Concerts","year":"2017","episode":"The Wings Tour","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","address":"","lat":35.8969,"lng":139.6303,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Front_of_Saitama_Super-Arena.JPG","fullDescription":{"en":"<p>BTS played three nights at Saitama Super Arena on June 20–22, 2017, as part of the Japanese leg of \"The Wings Tour.\" One of the largest arenas in the Tokyo metropolitan area, it's a regular stop for both Japanese and international acts and has also hosted world championship figure skating and Olympic qualifying events.</p><p>This was one of several multi-night Japanese stops on the tour, alongside Osaka, Nagoya, and Fukuoka, reflecting how the group's Japan-specific touring schedule had grown into its own extended leg rather than a single add-on date.</p>","fr":"<p>BTS s'est produit trois soirs au Saitama Super Arena les 20, 21 et 22 juin 2017, dans le cadre de l'étape japonaise de « The Wings Tour ». L'une des plus grandes arènes de la région métropolitaine de Tokyo, elle accueille régulièrement des artistes japonais et internationaux, ainsi que des championnats du monde de patinage artistique et des épreuves de qualification olympique.</p><p>Ce fut l'une des multiples étapes japonaises à plusieurs soirées de cette tournée, aux côtés d'Osaka, Nagoya et Fukuoka, reflet de l'ampleur qu'avait prise le calendrier de tournée spécifiquement japonais du groupe, devenu une étape à part entière plutôt qu'une simple date ajoutée.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":128,"name":"Marine Messe Fukuoka","group":"BTS","member":"All","country":"Japan","city":"Fukuoka","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":33.6489,"lng":130.3739,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Marine_Messe_Fukuoka_20161006.jpg","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>June 24–25, 2017 — The Wings Tour.</b> Marine Messe Fukuoka hosted a two-night stand on the Japanese leg of BTS's \"The Wings Tour,\" the group's first arena-scale tour across Japan following the runaway success of the \"Wings\" album. The Japan leg ran through June and July 2017 across five cities, part of a wider run that also crossed North America, South America and Australia.</p>","fr":"<p><b>24–25 juin 2017 — The Wings Tour.</b> La Marine Messe Fukuoka a accueilli deux soirs consécutifs de l'étape japonaise de « The Wings Tour » de BTS, leur première tournée à l'échelle des arénas au Japon après le succès de l'album « Wings ». Cette étape japonaise s'est déroulée en juin et juillet 2017 dans cinq villes, dans le cadre d'une tournée qui a aussi traversé l'Amérique du Nord, l'Amérique du Sud et l'Australie.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":129,"name":"Makomanai Sekisui Heim Ice Arena","group":"BTS","member":"All","country":"Japan","city":"Sapporo","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":43.0089,"lng":141.3489,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Makomanai_Ice_Arena.jpg","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>July 1–2, 2017 — The Wings Tour.</b> Makomanai Sekisui Heim Ice Arena, a former 1972 Winter Olympics venue, hosted a two-night stand that closed out the Japanese leg of BTS's \"The Wings Tour,\" the group's first arena-scale tour across Japan following the runaway success of the \"Wings\" album. The Japan leg ran through June and July 2017 across five cities, part of a wider run that also crossed North America, South America and Australia.</p>","fr":"<p><b>1er–2 juillet 2017 — The Wings Tour.</b> L'Arena Makomanai Sekisui Heim, ancien site des Jeux olympiques d'hiver de 1972, a accueilli deux soirs consécutifs qui ont clôturé l'étape japonaise de « The Wings Tour » de BTS, leur première tournée à l'échelle des arénas au Japon après le succès de l'album « Wings ». Cette étape japonaise s'est déroulée en juin et juillet 2017 dans cinq villes, dans le cadre d'une tournée qui a aussi traversé l'Amérique du Nord, l'Amérique du Sud et l'Australie.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":130,"name":"Kyocera Dome","group":"BTS","member":"All","country":"Japan","city":"Osaka","category":"Concerts","year":"2017 · 2018","episode":"The Wings Tour & Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":34.6688,"lng":135.4744,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Kyocera_Dome_Osaka1.jpg","fullDescription":{"en":"<p><b>October 14–15, 2017 — The Wings Tour.</b> BTS closed out the Japanese leg of \"The Wings Tour\" with two nights at Kyocera Dome, home of Japan's Orix Buffaloes baseball team.</p><p><b>November 21, 23–24, 2018 — Love Yourself World Tour.</b> A little over a year later, BTS returned for three more nights at the same dome — this time as the closing Japanese stop of the \"Love Yourself World Tour,\" right before the tour's final Asian leg into 2019.</p>","fr":"<p><b>14–15 octobre 2017 — The Wings Tour.</b> BTS a clôturé l'étape japonaise de « The Wings Tour » par deux soirées au Kyocera Dome, domicile de l'équipe de baseball japonaise des Orix Buffaloes.</p><p><b>21, 23–24 novembre 2018 — Love Yourself World Tour.</b> Un peu plus d'un an plus tard, BTS est revenu pour trois nouvelles soirées dans le même dôme — cette fois comme dernière étape japonaise du « Love Yourself World Tour », juste avant le prolongement asiatique de la tournée jusqu'en 2019.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":131,"name":"Taoyuan International Baseball Stadium","group":"BTS","member":"All","country":"Taiwan","city":"Taoyuan","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","address":"","lat":24.9903,"lng":121.301,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Taoyuan_International_Baseball_field,2009.JPG","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>December 8–9, 2018 — Love Yourself World Tour.</b> Taoyuan International Baseball Stadium hosted two nights of BTS's Taiwan stop on the \"Love Yourself\" World Tour, with a reported venue capacity of around 20,000. (Note: BTS's earlier Taiwan date, on \"The Wings Tour\" in October 2017, was actually held at NTSU Arena, a different venue in Taoyuan — not at this stadium.)</p>","fr":"<p><b>8–9 décembre 2018 — Love Yourself World Tour.</b> Le Taoyuan International Baseball Stadium a accueilli deux soirs de l'étape taïwanaise de BTS pour la tournée « Love Yourself », pour une capacité annoncée d'environ 20 000 personnes. (À noter : la date taïwanaise précédente de BTS, lors de « The Wings Tour » en octobre 2017, s'est en réalité tenue au NTSU Arena, une salle différente à Taoyuan — pas dans ce stade.)</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":132,"name":"Cotai Arena","group":"BTS","member":"All","country":"Macau","city":"Macau","category":"Concerts","year":"2017","episode":"The Wings Tour","address":"","lat":22.147,"lng":113.5533,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/55672-The-Rolling-Stones-14-On-Fire_(13063245954).jpg","episodeLink":"https://en.wikipedia.org/wiki/The_Wings_Tour","fullDescription":{"en":"<p><b>November 4, 2017 — The Wings Tour.</b> Cotai Arena at The Venetian Macao hosted BTS's Macau stop on \"The Wings Tour.\" Jimin performed part of the show seated after experiencing neck and shoulder pain, but the group completed the concert.</p>","fr":"<p><b>4 novembre 2017 — The Wings Tour.</b> Le Cotai Arena du Venetian Macao a accueilli l'étape macanaise de « The Wings Tour » de BTS. Jimin a assuré une partie du show assis après avoir ressenti des douleurs au cou et aux épaules, mais le groupe a mené le concert à son terme.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":133,"name":"Crypto.com Arena (Staples Center)","group":"BTS","member":"All","country":"USA","city":"Los Angeles, CA","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","address":"","lat":34.043,"lng":-118.2673,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Crypto.com_Arena_July_2022.JPG","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>September 5, 6, 8 & 9, 2018 — Love Yourself World Tour.</b> Then known as Staples Center, the arena hosted four sold-out nights of BTS's Los Angeles stop — a fourth date was added after the first three sold out within minutes, with fans reportedly camping outside the arena days ahead of the shows.</p>","fr":"<p><b>5, 6, 8 et 9 septembre 2018 — Love Yourself World Tour.</b> Alors appelée Staples Center, la salle a accueilli quatre soirs à guichets fermés de l'étape de Los Angeles de BTS — une quatrième date a été ajoutée après que les trois premières se soient vendues en quelques minutes, certains fans ayant campé devant la salle plusieurs jours à l'avance.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":134,"name":"Oracle Arena","group":"BTS","member":"All","country":"USA","city":"Oakland, CA","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","address":"","lat":37.7503,"lng":-122.203,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Oracle_Arena_exterior_1.JPG","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>September 12, 2018 — Love Yourself World Tour.</b> Oracle Arena hosted BTS's Oakland stop on the tour, which happened to fall on RM's birthday — fans reportedly chartered a plane to fly a \"Happy RM Day\" banner over the venue. A Bay Area critic called it one of the year's hottest shows in the region.</p>","fr":"<p><b>12 septembre 2018 — Love Yourself World Tour.</b> L'Oracle Arena a accueilli l'étape d'Oakland de la tournée de BTS, qui tombait ce jour-là sur l'anniversaire de RM — des fans auraient affrété un avion pour survoler la salle avec une banderole « Happy RM Day ». Un critique de la région l'a qualifié de l'un des concerts les plus marquants de l'année dans la Bay Area.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":135,"name":"Fort Worth Convention Center","group":"BTS","member":"All","country":"USA","city":"Fort Worth, TX","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","address":"","lat":32.7521,"lng":-97.3277,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Convention_Center_Fort_Worth.JPG","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>September 15–16, 2018 — Love Yourself World Tour.</b> Fort Worth Convention Center hosted two sold-out nights of BTS's Texas stop on the tour, part of the North American leg that followed shows in Los Angeles and Oakland earlier that same month.</p>","fr":"<p><b>15–16 septembre 2018 — Love Yourself World Tour.</b> Le Fort Worth Convention Center a accueilli deux soirs à guichets fermés de l'étape texane de la tournée de BTS, dans le cadre de l'étape nord-américaine qui a suivi les concerts de Los Angeles et d'Oakland le même mois.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":136,"name":"FirstOntario Centre","group":"BTS","member":"All","country":"Canada","city":"Hamilton, ON","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","address":"","lat":43.2586,"lng":-79.8712,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/FirstOntario_Centre_-_Hamilton.JPG","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>September 20, 22 & 23, 2018 — Love Yourself World Tour.</b> FirstOntario Centre hosted three nights of BTS's only Canadian stop on the tour. BTS were reported as the top-selling touring act and top-selling show in Canada for that fall.</p>","fr":"<p><b>20, 22 et 23 septembre 2018 — Love Yourself World Tour.</b> Le FirstOntario Centre a accueilli trois soirs de l'unique étape canadienne de BTS sur cette tournée. BTS ont été cités comme l'artiste en tournée et le concert les plus vendeurs au Canada cet automne-là.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":137,"name":"United Center","group":"BTS","member":"All","country":"USA","city":"Chicago, IL","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":41.8807,"lng":-87.6742,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/United_Center,_Chicago.JPG","fullDescription":{"en":"<p>BTS played two nights at the United Center on October 2–3, 2018, during the \"Love Yourself World Tour\" — the same arena that is home to the Chicago Bulls and Blackhawks, and where a statue of Michael Jordan stands outside the main entrance.</p><p>The Chicago stop came right between the Hamilton, Ontario shows and the tour's first-ever New York stadium date at Citi Field, part of a North American run that sold out arena after arena in a matter of minutes each time tickets went on sale.</p>","fr":"<p>BTS s'est produit deux soirs au United Center les 2 et 3 octobre 2018, dans le cadre du « Love Yourself World Tour » — la même arène qui est le domicile des Chicago Bulls et des Blackhawks, et devant laquelle se dresse une statue de Michael Jordan.</p><p>L'étape de Chicago s'est glissée entre les dates de Hamilton, en Ontario, et la toute première date en stade de la tournée à New York, à Citi Field — dans le cadre d'une tournée nord-américaine qui a vu chaque salle afficher complet en quelques minutes à chaque mise en vente.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":138,"name":"Citi Field","group":"BTS","member":"All","country":"USA","city":"New York, NY","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":40.7571,"lng":-73.8458,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Citi_Field_facade.jpg","fullDescription":{"en":"<p>On October 6, 2018, BTS filled Citi Field — home of the New York Mets — with roughly 40,000 fans as part of the \"Love Yourself World Tour,\" one of the largest single-night crowds the group had drawn in the US up to that point. Ticketing platform Vivid Seats later named BTS its 2018 Artist of the Year, specifically citing this concert as a defining, \"history-making\" moment of the group's US breakthrough.</p><p>It capped a North American run that had already sold out arenas from Los Angeles to Chicago — a baseball stadium in Queens was a different scale entirely.</p>","fr":"<p>Le 6 octobre 2018, BTS a rempli Citi Field — domicile des Mets de New York — devant environ 40 000 personnes, dans le cadre du « Love Yourself World Tour », l'une des plus grandes foules réunies par le groupe en une seule soirée aux États-Unis à cette date. La plateforme de billetterie Vivid Seats a plus tard désigné BTS comme son Artiste de l'année 2018, citant précisément ce concert comme un moment déterminant et « historique » de la percée du groupe aux États-Unis.</p><p>Ce concert concluait une tournée nord-américaine qui avait déjà rempli des arénas de Los Angeles à Chicago — mais un stade de baseball dans le Queens représentait un tout autre changement d'échelle.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":139,"name":"The O2 Arena","group":"BTS","member":"All","country":"UK","city":"London","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":51.5033,"lng":0.0032,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/The_O2_Arena,_entrance.jpg","fullDescription":{"en":"<p>BTS played two nights at The O2 on October 9–10, 2018, the UK stop of the \"Love Yourself World Tour\" — sandwiched between the Chicago/New York leg and stops in Amsterdam, Berlin, and Paris. It was one of the arena's biggest K-pop bookings at a time when the genre's stadium-scale drawing power in Europe was still a novelty.</p><p>The O2 has hosted virtually every major touring act of the last two decades, from Prince's 21-night residency to Adele — BTS's sold-out double-header put them in exactly that company.</p>","fr":"<p>BTS s'est produit deux soirs à The O2 les 9 et 10 octobre 2018, étape britannique du « Love Yourself World Tour » — coincée entre l'étape Chicago/New York et les dates d'Amsterdam, Berlin et Paris. C'était alors l'une des plus grosses programmations K-pop de la salle, à une époque où la capacité du genre à remplir des salles de cette taille en Europe restait une nouveauté.</p><p>The O2 a accueilli pratiquement tous les grands artistes en tournée des deux dernières décennies, de la résidence de 21 soirs de Prince à Adele — le double concert à guichets fermés de BTS les a placés dans cette même catégorie.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":140,"name":"Ziggo Dome","group":"BTS","member":"All","country":"Netherlands","city":"Amsterdam","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":52.3132,"lng":4.9382,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Ziggo_Dome.JPG","fullDescription":{"en":"<p>BTS played a single night at the Ziggo Dome on October 13, 2018, as part of the European leg of the \"Love Yourself World Tour,\" between the London and Berlin dates. With a capacity of around 17,000, it's the largest indoor arena in the Netherlands, and one of the busiest touring venues in continental Europe.</p><p>The Amsterdam stop is one of the tour's less-documented shows internationally, but it followed the same pattern as the rest of the European leg: tickets sold out well in advance of the show date.</p>","fr":"<p>BTS s'est produit une seule soirée au Ziggo Dome le 13 octobre 2018, dans le cadre de l'étape européenne du « Love Yourself World Tour », entre les dates de Londres et de Berlin. Avec une capacité d'environ 17 000 places, c'est la plus grande salle couverte des Pays-Bas, et l'une des salles de tournée les plus actives d'Europe continentale.</p><p>L'étape d'Amsterdam est l'une des dates les moins documentées de la tournée à l'international, mais elle a suivi le même schéma que le reste de l'étape européenne : les billets se sont vendus bien avant la date du concert.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":141,"name":"Mercedes-Benz Arena","group":"BTS","member":"All","country":"Germany","city":"Berlin","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":52.5058,"lng":13.4432,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Mercedes-Benz_Arena,_Berlin,_Germany.jpg","fullDescription":{"en":"<p>BTS played two nights at what was then called the Mercedes-Benz Arena on October 16–17, 2018, the German stop of the \"Love Yourself World Tour,\" between Amsterdam and Paris. The arena has since been renamed Uber Arena (2024), so don't be surprised if the name on the building itself no longer matches this entry.</p><p>Berlin has long been one of the strongest German-speaking markets for BTS, and this stop is remembered by ARMY largely for the sheer volume of the crowd during the ballad segments of the set.</p>","fr":"<p>BTS s'est produit deux soirs dans ce qui s'appelait alors la Mercedes-Benz Arena, les 16 et 17 octobre 2018, étape allemande du « Love Yourself World Tour », entre Amsterdam et Paris. La salle a depuis été rebaptisée Uber Arena (2024) — ne soyez donc pas surpris si le nom sur le bâtiment lui-même ne correspond plus à cette fiche.</p><p>Berlin a toujours été l'un des marchés germanophones les plus forts pour BTS, et cette étape est surtout restée dans les mémoires des ARMY pour l'intensité sonore du public pendant les passages plus lents du concert.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":142,"name":"Accor Arena","group":"BTS","member":"All","country":"France","city":"Paris","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":48.8388,"lng":2.3788,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/AccorHotels_Arena_@_Bercy_@_Paris_(27157316713).jpg","fullDescription":{"en":"<p>BTS played two nights at the Bercy arena — then named AccorHotels Arena — on October 19–20, 2018, the final European stop of the \"Love Yourself World Tour\" before the group flew to Japan. The venue, in the Bercy neighborhood of the 12th arrondissement, has been renamed twice since (Accor Arena, then Adidas Arena for the 2024 Olympics before reverting), and has hosted everything from Olympic gymnastics to decades of the biggest touring acts in music.</p><p>Paris has historically been one of BTS's strongest European fanbases, and the two Bercy shows are frequently cited by French ARMY as a turning point for K-pop's visibility in French mainstream media.</p>","fr":"<p>BTS s'est produit deux soirs à l'arène de Bercy — alors nommée AccorHotels Arena — les 19 et 20 octobre 2018, dernière étape européenne du « Love Yourself World Tour » avant l'envol du groupe pour le Japon. Cette salle du 12e arrondissement a changé de nom à deux reprises depuis (Accor Arena, puis Adidas Arena pour les Jeux olympiques de 2024 avant de revenir en arrière), et a accueilli aussi bien de la gymnastique olympique que des décennies des plus grands noms de la musique en tournée.</p><p>Paris a toujours été l'une des bases de fans européennes les plus fortes de BTS, et ces deux concerts à Bercy sont souvent cités par les ARMY françaises comme un tournant pour la visibilité de la K-pop dans les médias grand public français.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":143,"name":"Tokyo Dome","group":"BTS","member":"All","country":"Japan","city":"Tokyo","category":"Concerts","year":"2018","episode":"Love Yourself World Tour","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":35.7056,"lng":139.7519,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Tokyo_dome.JPG","fullDescription":{"en":"<p>BTS played Tokyo Dome on November 13–14, 2018, as part of the \"Love Yourself World Tour.\" In Japan's music industry, headlining Tokyo Dome — a roughly 55,000-capacity venue nicknamed \"The Big Egg\" — is treated as a career milestone in itself, reserved for the biggest domestic and international acts.</p><p>It was one of several Japanese dome shows on that tour, alongside Kyocera Dome in Osaka, reflecting how large and long-running BTS's Japanese fanbase already was by 2018, built up over years of releases and tours specifically for that market.</p>","fr":"<p>BTS s'est produit au Tokyo Dome les 13 et 14 novembre 2018, dans le cadre du « Love Yourself World Tour ». Dans l'industrie musicale japonaise, être tête d'affiche au Tokyo Dome — une salle d'environ 55 000 places surnommée « The Big Egg » — est en soi considéré comme une consécration de carrière, réservée aux plus grands artistes japonais et internationaux.</p><p>Ce fut l'une des plusieurs dates dans des dômes japonais de cette tournée, aux côtés du Kyocera Dome à Osaka, reflet de l'ampleur déjà considérable et ancienne de la base de fans japonaise de BTS en 2018, construite au fil d'années de sorties et de tournées spécifiquement pensées pour ce marché.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":144,"name":"Nagoya Dome","group":"BTS","member":"All","country":"Japan","city":"Nagoya","category":"Concerts","year":"2019","episode":"Love Yourself World Tour","address":"","lat":35.1855,"lng":136.9457,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Nagoya_Dome_01.JPG","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>January 12–13, 2019 — Love Yourself World Tour.</b> Nagoya Dome hosted two nights of the Japanese leg of BTS's \"Love Yourself\" tour, part of a Japan run across Tokyo, Osaka, Nagoya and Fukuoka that drew a combined 380,000 fans.</p>","fr":"<p><b>12–13 janvier 2019 — Love Yourself World Tour.</b> Le Nagoya Dome a accueilli deux soirs de l'étape japonaise de la tournée « Love Yourself » de BTS, dans le cadre d'une série de concerts au Japon (Tokyo, Osaka, Nagoya et Fukuoka) qui a rassemblé 380 000 fans au total.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":145,"name":"National Stadium","group":"BTS","member":"All","country":"Singapore","city":"Singapore","category":"Concerts","year":"2019","episode":"Love Yourself World Tour","address":"","lat":1.3033,"lng":103.8748,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Singapore_Singapore-Sports-Hub-with-National-Stadium-01.jpg","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>January 19, 2019 — Love Yourself World Tour.</b> BTS became the first Korean act to play Singapore's National Stadium at the Sports Hub, and the first K-pop act to sell it out, drawing a reported crowd of around 45,000 for a single show — their first solo Singapore concert in over four years.</p>","fr":"<p><b>19 janvier 2019 — Love Yourself World Tour.</b> BTS est devenu le premier artiste coréen à se produire au National Stadium du Singapore Sports Hub, et le premier acte K-pop à afficher complet dans cette salle, réunissant environ 45 000 spectateurs pour un concert unique — leur premier concert solo à Singapour en plus de quatre ans.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":146,"name":"Fukuoka PayPay Dome (Yahuoku! Dome)","group":"BTS","member":"All","country":"Japan","city":"Fukuoka","category":"Concerts","year":"2019","episode":"Love Yourself World Tour","address":"","lat":33.5954,"lng":130.3618,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Fukuoka_Yahuoku_Dome.jpg","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>February 16–17, 2019 — Love Yourself World Tour.</b> Then known as Fukuoka Yahuoku! Dome, the venue closed out the Japanese leg of BTS's \"Love Yourself\" tour with two nights, part of a Japan run across Tokyo, Osaka, Nagoya and Fukuoka that drew a combined 380,000 fans.</p>","fr":"<p><b>16–17 février 2019 — Love Yourself World Tour.</b> Alors appelé Fukuoka Yahuoku! Dome, le lieu a clôturé l'étape japonaise de la tournée « Love Yourself » de BTS avec deux soirs, dans le cadre d'une série de concerts au Japon (Tokyo, Osaka, Nagoya et Fukuoka) qui a rassemblé 380 000 fans au total.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":147,"name":"Rajamangala National Stadium","group":"BTS","member":"All","country":"Thailand","city":"Bangkok","category":"Concerts","year":"2019","episode":"Love Yourself World Tour","address":"","lat":13.7563,"lng":100.6242,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Rajamangala_Stadium_in_Bangkok.jpg","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>April 6–7, 2019 — Love Yourself World Tour.</b> Rajamangala National Stadium, a roughly 50,000-capacity venue, hosted the final two shows of BTS's \"Love Yourself\" World Tour, closing out a run that had taken the group across five continents.</p>","fr":"<p><b>6–7 avril 2019 — Love Yourself World Tour.</b> Le Rajamangala National Stadium, d'une capacité d'environ 50 000 places, a accueilli les deux derniers concerts de la tournée mondiale « Love Yourself » de BTS, clôturant un parcours qui avait mené le groupe sur cinq continents.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":148,"name":"Rose Bowl Stadium","group":"BTS","member":"All","country":"USA","city":"Pasadena, CA","category":"Concerts","year":"2019","episode":"Love Yourself: Speak Yourself","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":34.1613,"lng":-118.1676,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Rose_Bowl_aerial.jpg","fullDescription":{"en":"<p>May 4–5, 2019 marked the opening weekend of BTS's first-ever stadium tour, \"Love Yourself: Speak Yourself\" — and they chose the Rose Bowl to start it. The two sold-out nights grossed roughly $16.6 million, making it the highest-grossing concert event in the stadium's history at the time, ahead of acts like Taylor Swift and U2.</p><p>Every stop on the rest of that tour — Chicago, MetLife, Wembley — followed the template set here: BTS as a stadium act in its own right, not an opening act or a festival booking.</p>","fr":"<p>Les 4 et 5 mai 2019 ont marqué le week-end d'ouverture de la toute première tournée en stades de BTS, « Love Yourself: Speak Yourself » — et c'est au Rose Bowl qu'elle a commencé. Les deux soirées à guichets fermés ont rapporté environ 16,6 millions de dollars, faisant de cet événement le concert le plus rentable de l'histoire du stade à l'époque, devant des artistes comme Taylor Swift et U2.</p><p>Toutes les étapes suivantes de cette tournée — Chicago, MetLife, Wembley — ont suivi le modèle fixé ici : BTS en tant que groupe de stade à part entière, non comme première partie ou programmation de festival.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":149,"name":"Soldier Field","group":"BTS","member":"All","country":"USA","city":"Chicago, IL","category":"Concerts","year":"2019 · 2026","episode":"Love Yourself: Speak Yourself & World Tour 'ARIRANG'","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":41.8623,"lng":-87.6167,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Soldier_Field,_Chicago,_Illinois.jpg","fullDescription":{"en":"<p><b>May 11–12, 2019 — Love Yourself: Speak Yourself.</b> BTS played Soldier Field, one of the NFL's oldest and most storied stadiums, as the second stop of their first-ever stadium tour, right after opening the run at the Rose Bowl.</p><p><b>August 27–28, 2026 — World Tour \"ARIRANG.\"</b> BTS returned to the same lakefront stadium seven years later for the Chicago stop of \"ARIRANG,\" their sixth all-stadium tour and first full run since completing military service.</p>","fr":"<p><b>11–12 mai 2019 — Love Yourself: Speak Yourself.</b> BTS s'est produit à Soldier Field, l'un des stades les plus anciens et les plus emblématiques de la NFL, pour la deuxième étape de sa toute première tournée en stades, juste après avoir ouvert la tournée au Rose Bowl.</p><p><b>27–28 août 2026 — World Tour « ARIRANG ».</b> BTS est revenu dans ce même stade en bord de lac sept ans plus tard pour l'étape de Chicago d'« ARIRANG », sa sixième tournée entièrement en stades et première tournée complète depuis la fin de son service militaire.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":150,"name":"MetLife Stadium","group":"BTS","member":"All","country":"USA","city":"East Rutherford, NJ","category":"Concerts","year":"2019 · 2026","episode":"Love Yourself: Speak Yourself & World Tour 'ARIRANG'","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":40.8135,"lng":-74.0745,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/MetLife_Stadium_Exterior.jpg","fullDescription":{"en":"<p><b>May 18–19, 2019 — Love Yourself: Speak Yourself.</b> BTS played MetLife Stadium as an early stop on their first-ever stadium tour, days after opening the whole run with a record-breaking two nights at the Rose Bowl.</p><p><b>August 1–2, 2026 — World Tour 'ARIRANG.'</b> Seven years on, BTS returned to the same stadium for the New York-area stop of their sixth all-stadium tour, \"ARIRANG,\" their first full run together since completing military service — the same building bookending two very different chapters of the group's career.</p>","fr":"<p><b>18–19 mai 2019 — Love Yourself: Speak Yourself.</b> BTS s'est produit au MetLife Stadium lors d'une étape précoce de sa toute première tournée en stades, quelques jours seulement après avoir ouvert cette tournée par deux soirées record au Rose Bowl.</p><p><b>1er–2 août 2026 — World Tour « ARIRANG ».</b> Sept ans plus tard, BTS est revenu dans ce même stade pour l'étape new-yorkaise de sa sixième tournée entièrement en stades, « ARIRANG », la première tournée complète du groupe depuis la fin de son service militaire — un même lieu qui referme la boucle entre deux chapitres très différents de sa carrière.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":151,"name":"Allianz Parque","group":"BTS","member":"All","country":"Brazil","city":"São Paulo","category":"Concerts","year":"2019","episode":"Love Yourself: Speak Yourself","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":-23.5273,"lng":-46.678,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Allianz_Parque.jpg","fullDescription":{"en":"<p>BTS played Allianz Parque on May 25–26, 2019, the South American stop of \"Love Yourself: Speak Yourself\" — their first stadium tour — coming right after the Rose Bowl and MetLife Stadium dates in the US. The venue, better known as the home of football club Palmeiras, was reconfigured for two full stadium concerts.</p><p>Brazil has consistently been one of BTS's largest fanbases outside Asia, and this stop is regularly cited by ARMY as one of the loudest crowds of the entire tour.</p>","fr":"<p>BTS s'est produit à l'Allianz Parque les 25 et 26 mai 2019, étape sud-américaine de « Love Yourself: Speak Yourself » — sa première tournée en stades — juste après les dates au Rose Bowl et au MetLife Stadium aux États-Unis. Ce stade, surtout connu comme le domicile du club de football Palmeiras, a été reconfiguré pour deux concerts complets.</p><p>Le Brésil a toujours compté parmi les plus grandes bases de fans de BTS en dehors de l'Asie, et cette étape est régulièrement citée par les ARMY comme l'une des foules les plus bruyantes de toute la tournée.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":152,"name":"Wembley Stadium","group":"BTS","member":"All","country":"UK","city":"London","category":"Concerts","year":"2019","episode":"Love Yourself: Speak Yourself","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":51.556,"lng":-0.2795,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Wembley_Stadium,_From_the_Outside.JPG","fullDescription":{"en":"<p>BTS played Wembley Stadium on June 1–2, 2019, the European stop of \"Love Yourself: Speak Yourself.\" The show sold out in around 90 minutes when tickets went on sale, in one of the most storied venues in world music and sport — the same stadium that has hosted Live Aid, the Euros, and decades of stadium tours by some of the biggest acts in the world.</p><p>It remains one of the most-cited stops of the tour among ARMY, both for the scale of the venue and for what it represented: a K-pop group headlining Wembley on its own name.</p>","fr":"<p>BTS s'est produit au Wembley Stadium les 1er et 2 juin 2019, étape européenne de « Love Yourself: Speak Yourself ». Le concert a affiché complet en environ 90 minutes dès la mise en vente des billets, dans l'un des lieux les plus mythiques de la musique et du sport mondial — le même stade qui a accueilli Live Aid, l'Euro, et des décennies de tournées en stade des plus grands noms de la musique.</p><p>Cette étape reste l'une des plus citées de la tournée par les ARMY, tant pour l'ampleur du lieu que pour ce qu'elle représentait : un groupe de K-pop en tête d'affiche à Wembley sous son propre nom.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":153,"name":"Nagai Stadium (Yanmar Stadium)","group":"BTS","member":"All","country":"Japan","city":"Osaka","category":"Concerts","year":"2019","episode":"Love Yourself: Speak Yourself","address":"","lat":34.6117,"lng":135.5188,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Yammar_Stadium_Nagai.jpg","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>July 6–7, 2019 — Love Yourself: Speak Yourself.</b> Yanmar Stadium Nagai hosted two nights of the Japanese stadium leg of BTS's tour, part of a run that had already crossed North America, South America and Europe before returning to Asia.</p>","fr":"<p><b>6–7 juillet 2019 — Love Yourself: Speak Yourself.</b> Le Yanmar Stadium Nagai a accueilli deux soirs de l'étape stade japonaise de la tournée de BTS, dans le cadre d'un parcours qui avait déjà traversé l'Amérique du Nord, l'Amérique du Sud et l'Europe avant de revenir en Asie.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":154,"name":"Shizuoka Stadium Ecopa","group":"BTS","member":"All","country":"Japan","city":"Shizuoka","category":"Concerts","year":"2019","episode":"Love Yourself: Speak Yourself","address":"","lat":34.8161,"lng":137.9433,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/Shizuoka_Stadium_ECOPA.jpg","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","fullDescription":{"en":"<p><b>July 13–14, 2019 — Love Yourself: Speak Yourself.</b> Shizuoka Stadium Ecopa hosted the final Japanese dates of BTS's stadium tour that July, closing out a run of four Japan shows that succeeded despite a period of diplomatic tension between Japan and South Korea at the time.</p>","fr":"<p><b>13–14 juillet 2019 — Love Yourself: Speak Yourself.</b> Le Shizuoka Stadium Ecopa a accueilli les dernières dates japonaises de la tournée stade de BTS ce mois de juillet-là, clôturant une série de quatre concerts au Japon qui ont rencontré un franc succès malgré des tensions diplomatiques entre le Japon et la Corée du Sud à cette période.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    {"id":155,"name":"King Fahd International Stadium","group":"BTS","member":"All","country":"Saudi Arabia","city":"Riyadh","category":"Concerts","year":"2019","episode":"Love Yourself: Speak Yourself","episodeLink":"https://en.wikipedia.org/wiki/Love_Yourself_World_Tour","address":"","lat":24.7136,"lng":46.7208,"img":"https://commons.wikimedia.org/wiki/Special:FilePath/King_Fahd_International_Stadium.jpg","fullDescription":{"en":"<p>On October 11, 2019, BTS became the first foreign artist to headline a solo concert at a large-scale stadium in Saudi Arabia, playing King Fahd International Stadium in Riyadh as an added date on the \"Love Yourself: Speak Yourself\" tour. The show came as the country was beginning to open up to large Western and international live entertainment as part of a broader cultural shift.</p><p>It was one of the more unusual and historically notable stops of the whole tour precisely because it wasn't part of the original schedule — added after the rest of the tour had already sold out.</p>","fr":"<p>Le 11 octobre 2019, BTS devient le premier artiste étranger à être tête d'affiche d'un concert solo dans un grand stade en Arabie saoudite, se produisant au King Fahd International Stadium de Riyad, en date ajoutée à la tournée « Love Yourself: Speak Yourself ». Ce concert intervenait alors que le pays commençait tout juste à s'ouvrir aux grands spectacles occidentaux et internationaux, dans le cadre d'une évolution culturelle plus large.</p><p>Ce fut l'une des étapes les plus singulières et historiquement notables de toute la tournée, précisément parce qu'elle ne faisait pas partie du calendrier initial — ajoutée après que le reste de la tournée avait déjà affiché complet.</p>"},"tip":{"en":"This stop is from an earlier BTS world tour — check the venue's own website for current opening hours or public tours, as they can change independently of the concert date shown here.","fr":"Cette étape provient d'une tournée mondiale précédente de BTS — vérifiez le site officiel du lieu pour les horaires d'ouverture ou visites publiques actuelles, qui peuvent avoir changé depuis la date de concert indiquée ici."},"directions":{"en":"Check the venue's official website or a map app for the best way to reach it from where you're staying — public transit access varies a lot by city.","fr":"Consultez le site officiel du lieu ou une application de cartes pour le meilleur moyen de vous y rendre depuis votre logement — l'accès en transport en commun varie beaucoup selon la ville."}},
    ...
    { id: 172, name: "The Troubadour", group: "BTS", member: "All", country: "United States", city: "West Hollywood, CA", category: "Concerts", year: "2014", ytId: "gCOw09Xy4i0", episodeLink: "https://www.youtube.com/watch?v=gCOw09Xy4i0", address: "9081 Santa Monica Blvd, West Hollywood, CA 90069", lat: 34.0809, lng: -118.39, img: "https://commons.wikimedia.org/wiki/Special:FilePath/Troubadour_01.jpg",
      fullDescription: { en: `<p>On July 14, 2014, during their stay in Los Angeles for the reality show "American Hustle Life," BTS played a free surprise showcase at the Troubadour, the legendary West Hollywood club where acts like Elton John and Guns N' Roses got their start.</p><p>For a group still filling venues of a few thousand seats back home, playing this storied stage was a small, quiet milestone in LA live-music history — a striking contrast to the stadium tours that would follow just a few years later.</p>`,
        fr: `<p>Le 14 juillet 2014, pendant leur séjour à Los Angeles pour l'émission de téléréalité « American Hustle Life », BTS a donné un showcase surprise gratuit au Troubadour, le club légendaire de West Hollywood où des artistes tels qu'Elton John ou Guns N' Roses ont fait leurs débuts.</p><p>Pour un groupe qui remplissait encore des salles de quelques milliers de places au pays, se produire sur cette scène chargée d'histoire fut un moment rare et discret dans l'histoire musicale live de LA — un contraste saisissant avec les tournées de stades qui suivraient à peine quelques années plus tard.</p>` },
...
function addSingleLocationMarker(loc, visitedData) {
    ...
    // groupe — l'icône de catégorie encombrait visuellement la carte. Le contour (non
    // visité) / remplissage plein (visité) est conservé, seule l'icône a été retirée ;
    // le survol et le repère de sélection (.custom-category-marker:hover,
    // highlightSelectedLocationMarker()) restent inchangés.
    const isVisited = visitedData.some(v => v.id === loc.id || v === loc.id);
    const baseColor = groupColors[loc.group] || '#334e68';

    let inlineStyle = `border-color: ${baseColor}; --marker-color: ${baseColor};`;
    inlineStyle += isVisited ? ` background-color: ${baseColor};` : ` background-color: white;`;

    const customIcon = L.divIcon({ className: 'custom-category-marker location-dot-marker', html: `<div style="${inlineStyle}"></div>`, iconSize: [18,18], iconAnchor: [9,9] });
